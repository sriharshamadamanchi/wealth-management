...
(function (global, factory) {
  ...
  function calcSupport() {
    ...
    return {
      ...
      touch: Boolean("ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch),
  ...
  function onTouchStart(event) {
    ...
    const swipingClassHasValue = Boolean(params.noSwipingClass) && params.noSwipingClass !== ""; // eslint-disable-next-line
    ...
    const isTargetShadow = Boolean(e.target && e.target.shadowRoot); // use closestElement for shadow root element to get the actual closest for nested shadow root element
  ...
  const events = (swiper, method) => {
    ...
    const capture = Boolean(params.nested);
