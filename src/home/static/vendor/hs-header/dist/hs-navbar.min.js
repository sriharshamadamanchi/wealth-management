...
!function(e, t){
  ...
  return d = { "./src/js/hs-navbar.js"(module, __webpack_exports__, __webpack_require__){
    ...
    if (1 & e && (t = f(t)), 8 & e) {
      ...
      return t;
    } var n = Object.create(null);if (f.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: t }), 2 & e && typeof t !== "string") {
      for (var s in t){
        f.d(n, s, ((e) => {
          return t[e]
        }).bind(null, s));
  ...
  }, f.p = "", f(f.s = "./src/js/hs-navbar.js").default;function f(t){
    if (e[t]) {
      return e[t].exports;
