...
export default function desktopMouseEnterEventListener(el, menu, params, itemParams) {
  return function () {
    ...
    const $siblingInvokers = menu.closest(`${params.classMap.hasMegaMenu}, ${params.classMap.hasSubMenu}`).parentNode.querySelectorAll(`${params.classMap.hasMegaMenu}${params.classMap.hasMegaMenuActive}, ${params.classMap.hasSubMenu}${params.classMap.hasSubMenuActive}`);
    ...
    if ($siblingInvokers.length) {
      $siblingInvokers.forEach(($el) => {
        ...
        itemSettings = { ...itemSettings, ...itemDataSettings };
