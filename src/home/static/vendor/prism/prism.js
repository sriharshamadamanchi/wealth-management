...
var _self = typeof window !== "undefined" ? window : typeof WorkerGlobalScope !== "undefined" && self instanceof WorkerGlobalScope ? self : {}, Prism = function(){
  var e = /\blang(?:uage)?-(\w+)\b/i, t = 0, n = _self.Prism = { manual: _self.Prism && _self.Prism.manual, disableWorkerMessageHandler: _self.Prism && _self.Prism.disableWorkerMessageHandler, util: { encode(e){
      ...
      var r = n.util.type(e);switch (t ||= {}, r){
      case "Object":if (t[n.util.objId(e)]) {
        return t[n.util.objId(e)];
      } var a = {};t[n.util.objId(e)] = a;for (var l in e){
          e.hasOwnProperty(l) && (a[l] = n.util.clone(e[l], t));
        }

        return a;case "Array":if (t[n.util.objId(e)]) {
        return t[n.util.objId(e)];
      } var a = [];

        return t[n.util.objId(e)] = a, e.forEach((e, r) => {
          a[r] = n.util.clone(e, t)
        }), a
      }

      return e
    } }, languages: { extend(e, t){
      ...
      a ||= n.languages;var l = a[e];if (arguments.length == 2){
      ...
      a ||= {};for (var l in e){
        e.hasOwnProperty(l) && (t.call(e, l, e[l], r || l), n.util.type(e[l]) !== "Object" || a[n.util.objId(e[l])] ? n.util.type(e[l]) !== "Array" || a[n.util.objId(e[l])] || (a[n.util.objId(e[l])] = !0, n.languages.DFS(e[l], t, l, a)) : (a[n.util.objId(e[l])] = !0, n.languages.DFS(e[l], t, null, a)))
      }
    } }, plugins: {}, highlightAll(e, t){
      ...
      for (var l, i, o = t;o && !e.test(o.className);){
        ...
        u.highlightedCode = n.highlight(u.code, u.grammar, u.language), n.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, a && a.call(t), n.hooks.run("after-highlight", u), n.hooks.run("complete", u)
      }
    }, highlight(e, t, a){
      ...
      var s = n.Token;for (var u in r) {
        if (r.hasOwnProperty(u) && r[u]){
          if (u == o) {
            return;
          } var g = r[u];g = n.util.type(g) === "Array" ? g : [g];for (var c = 0;c < g.length;++c){
            var h = g[c], f = h.inside, d = Boolean(h.lookbehind), m = Boolean(h.greedy), p = 0, y = h.alias;if (m && !h.pattern.global){
              ...
              var w = t[b];if (t.length > e.length) {
                return;
              } if (!(w instanceof s)){
                if (m && b != t.length - 1){
                  h.lastIndex = k;var _ = h.exec(e);if (!_) {
                    break;
                  ...
                  h.lastIndex = 0;var _ = h.exec(w), I = 1
                } if (_){
                  d && (p = _[1] ? _[1].length : 0);var j = _.index + p, _ = _[0].slice(p), P = j + _.length, N = w.slice(0, j), S = w.slice(P), C = [b, I];N && (++b, k += N.length, C.push(N));var E = new s(u, f ? n.tokenize(_, f) : _, y, _, m);if (C.push(E), S && C.push(S), Array.prototype.splice.apply(t, C), I != 1 && n.matchGrammar(e, t, r, b, k, !0, u), i) {
                    break
                  }
                } else if (i) {
                  break
      ...
      var r = n.hooks.all[e];if (r && r.length) {
        for (var a, l = 0;a = r[l++];){
          a(t)
        }
      }
    } } }, r = n.Token = function(e, t, n, r, a){
      this.type = e, this.content = t, this.alias = n, this.length = 0 | (r || "").length, this.greedy = Boolean(a)
    ...
    } var l = { type: e.type, content: r.stringify(e.content, t, a), tag: "span", classes: ["token", e.type], attributes: {}, language: t, parent: a };if (e.alias){
      var i = n.util.type(e.alias) === "Array" ? e.alias : [e.alias];Array.prototype.push.apply(l.classes, i)
    }n.hooks.run("wrap", l);var o = Object.keys(l.attributes).map((e) => {
      return `${e}="${(l.attributes[e] || "").replace(/"/g, "&quot;")}"`
    }).join(" ");

    return `<${ l.tag } class="${ l.classes.join(" ") }"${ o ? ` ${ o}` : "" }>${ l.content }</${ l.tag }>`
  }, !_self.document) {
    return _self.addEventListener ? (n.disableWorkerMessageHandler || _self.addEventListener("message", (e) => {
      var t = JSON.parse(e.data), r = t.language, a = t.code, l = t.immediateClose;_self.postMessage(n.highlight(a, n.languages[r], r)), l && _self.close()
    }, !1), _self.Prism) : _self.Prism;
  } var a = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();

  return a && (n.filename = a.src, n.manual || a.hasAttribute("data-manual") || (document.readyState !== "loading" ? window.requestAnimationFrame ? window.requestAnimationFrame(n.highlightAll) : window.setTimeout(n.highlightAll, 16) : document.addEventListener("DOMContentLoaded", n.highlightAll))), _self.Prism
}();typeof module !== "undefined" && module.exports && (module.exports = Prism), typeof global !== "undefined" && (global.Prism = Prism);
Prism.languages.markup = { comment: /<!--[\s\S]*?-->/, prolog: /<\?[\s\S]+?\?>/, doctype: /<!DOCTYPE[\s\S]+?>/i, cdata: /<!\[CDATA\[[\s\S]*?]]>/i, tag: { pattern: /<\/?(?!\d)[^\s>\/=$<%]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|[^\s'">=]+))?)*\s*\/?>/i, greedy: !0, inside: { tag: { pattern: /^<\/?[^\s>\/]+/i, inside: { punctuation: /^<\/?/, namespace: /^[^\s>\/:]+:/ } }, "attr-value": { pattern: /[=](?:("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|[^\s'">=]+)/i, inside: { punctuation: [/^=/, { pattern: /(^|[^\\])["']/, lookbehind: !0 }] } }, punctuation: /\/?>/, "attr-name": { pattern: /[^\s>\/]+/, inside: { namespace: /^[^\s>\/:]+:/ } } } }, entity: /&#?[\da-z]{1,8};/i }, Prism.languages.markup.tag.inside["attr-value"].inside.entity = Prism.languages.markup.entity, Prism.hooks.add("wrap", (a) => {
...
!function(){
  if (typeof self !== "undefined" && self.Prism && self.document){
    var t = [], e = {}, n = function(){};Prism.plugins.toolbar = {};var a = Prism.plugins.toolbar.registerButton = function(n, a){
        var o;o = typeof a === "function" ? a : function(t){
          var e;

          return typeof a.onClick === "function" ? (e = document.createElement("button"), e.type = "button", e.addEventListener("click", function(){
            a.onClick.call(this, t)
          })) : typeof a.url === "string" ? (e = document.createElement("a"), e.href = a.url) : e = document.createElement("span"), e.textContent = a.text, e
        }, t.push(e[n] = o)
        ...
        var o = a.element.parentNode;if (o && /pre/i.test(o.nodeName) && !o.parentNode.classList.contains("code-toolbar")){
          var r = document.createElement("div");r.classList.add("code-toolbar"), o.parentNode.insertBefore(r, o), r.appendChild(o);var i = document.createElement("div");i.classList.add("toolbar"), document.body.hasAttribute("data-toolbar-order") && (t = document.body.getAttribute("data-toolbar-order").split(",").map((t) => {
            return e[t] || n
          })), t.forEach((t) => {
            var e = t(a);if (e){
      ...
      var e = t.element.parentNode;if (e && /pre/i.test(e.nodeName) && e.hasAttribute("data-label")){
        var n, a, o = e.getAttribute("data-label");try {
...
!function(){
  function e(e){
    ...
    return e
  };e.prototype = { setDefaults(e){
    this.defaults = r(this.defaults, e)
  }, normalize(e, t){
    t = r(this.defaults, t);for (var i in t){
      var o = n(i);i !== "normalize" && o !== "setDefaults" && t[i] && this[o] && (e = this[o].call(this, e, t[i]))
    }
  ...
  }, removeInitialLineFeed(e){
    return e.replace(/^(?:\r?\n|\r)/, "")
  }, removeIndent(e){
    var n = e.match(/^[^\S\n\r]*(?=\S)/gm);

    return n && n[0].length ? (n.sort((e, n) => {
    ...
    return r.join("\n")
  } }, typeof module !== "undefined" && module.exports && (module.exports = e), typeof Prism !== "undefined" && (Prism.plugins.NormalizeWhitespace = new e({ "remove-trailing": !0, "remove-indent": !0, "left-trim": !0, "right-trim": !0 }), Prism.hooks.add("before-sanity-check", (e) => {
    var n = Prism.plugins.NormalizeWhitespace;if (!e.settings || e.settings["whitespace-normalization"] !== !1){
      ...
      } var t = e.element.parentNode, r = /\bno-whitespace-normalization\b/;if (e.code && t && t.nodeName.toLowerCase() === "pre" && !r.test(t.className) && !r.test(e.element.className)){
        for (var i = t.childNodes, o = "", a = "", s = !1, l = 0;l < i.length;++l){
          var c = i[l];c == e.element ? s = !0 : c.nodeName === "#text" && (s ? a += c.nodeValue : o += c.nodeValue, t.removeChild(c), --l)
...
!function(){
  if (typeof self !== "undefined" && self.Prism && self.document){
    ...
    } var o = window.ClipboardJS || void 0;o || typeof require !== "function" || (o = require("clipboard"));var e = [];if (!o){
      var t = document.createElement("script"), n = document.querySelector("head");t.onload = function(){
    ...
    }Prism.plugins.toolbar.registerButton("copy-to-clipboard", (t) => {
      function n(){
        var e = new o(i, { text(){
          return t.code
        } });e.on("success", () => {
