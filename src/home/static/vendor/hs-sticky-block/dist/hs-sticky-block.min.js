...
!function(t, e){
  typeof exports === "object" && typeof module === "object" ? module.exports = e() : typeof define === "function" && define.amd ? define([], e) : typeof exports === "object" ? exports.HSStickyBlock = e() : t.HSStickyBlock = e()
}(window, () => {
  return d = { "./src/js/hs-sticky-block.js"(module, __webpack_exports__, __webpack_require__){
    ...
    if (1 & t && (e = f(e)), 8 & t) {
      ...
      return e;
    } var n = Object.create(null);if (f.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: e }), 2 & t && typeof e !== "string") {
      for (var i in e){
        f.d(n, i, ((t) => {
          return e[t]
        }).bind(null, i));
  ...
  }, f.p = "", f(f.s = "./src/js/hs-sticky-block.js").default;function f(t){
    if (e[t]) {
      return e[t].exports;
