...
!function(n, t){
  typeof exports === "object" && typeof module === "object" ? module.exports = t() : typeof define === "function" && define.amd ? define([], t) : typeof exports === "object" ? exports.HSShowAnimation = t() : n.HSShowAnimation = t()
}(window, () => {
  return d = { "./src/js/hs-show-animation.js"(module, __webpack_exports__, __webpack_require__){
  ...
  }, "./src/js/utils.js"(module, __webpack_exports__, __webpack_require__){
    ...
    if (1 & n && (t = f(t)), 8 & n) {
      ...
      return t;
    } var e = Object.create(null);if (f.r(e), Object.defineProperty(e, "default", { enumerable: !0, value: t }), 2 & n && typeof t !== "string") {
      for (var i in t){
        f.d(e, i, ((n) => {
          return t[n]
        }).bind(null, i));
  ...
  }, f.p = "", f(f.s = "./src/js/hs-show-animation.js").default;function f(n){
    if (e[n]) {
      return e[n].exports;
