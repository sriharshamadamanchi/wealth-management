    ...
    /******/ 	var __webpack_modules__ = ({
      ...
      /***/ (function(module, __unused_webpack_exports, __webpack_require__) {
        ...
        module.exports = function (list, options) {
          ...
          events.bind(getByClass(list.listContainer, options.searchClass), "keyup", list.utils.events.debounce((e) => {
        ...
        module.exports = function (list) {
          return function (initValues, element, notCreate) {
            ...
            this.visible = function () {
              return Boolean(item.elm && item.elm.parentNode == list.list);
            };
      ...
      /***/ (function(module) {
        ...
        module.exports = function (_list) {
          ...
          _list.utils.events.bind(_list.utils.getByClass(_list.listContainer, _list.searchClass), "keyup", _list.utils.events.debounce((e) => {
            var target = e.target || e.srcElement,
              // IE have srcElement
          ...
          _list.utils.events.bind(_list.utils.getByClass(_list.listContainer, _list.searchClass), "input", (e) => {
            var target = e.target || e.srcElement;
      ...
      /***/ (function(module, __unused_webpack_exports, __webpack_require__) {
        ...
        ClassList.prototype.has = ClassList.prototype.contains = function (name) {
          return this.list ? this.list.contains(name) : Boolean(~index(this.array(), name));
        };
      ...
      /***/ (function(module) {
        ...
        function naturalCompare(a, b) {
          var lengthA = (a = String(a)).length;
          var lengthB = (b = String(b)).length;
          var aIndex = 0;
          var bIndex = 0;
