...
!function(n, e){
  typeof exports === "object" && typeof module === "object" ? module.exports = e() : typeof define === "function" && define.amd ? define([], e) : typeof exports === "object" ? exports.HSGoTo = e() : n.HSGoTo = e()
}(window, () => {
  return d = { "./src/js/hs-go-to.js"(module, __webpack_exports__, __webpack_require__){
  ...
  }, "./src/utils/scrollTo.js"(module, __webpack_exports__, __webpack_require__){
    ...
    if (1 & n && (e = f(e)), 8 & n) {
      ...
      return e;
    } var t = Object.create(null);if (f.r(t), Object.defineProperty(t, "default", { enumerable: !0, value: e }), 2 & n && typeof e !== "string") {
      for (var o in e){
        f.d(t, o, ((n) => {
          return e[n]
        }).bind(null, o));
  ...
  }, f.p = "", f(f.s = "./src/js/hs-go-to.js").default;function f(n){
    if (e[n]) {
      return e[n].exports;
